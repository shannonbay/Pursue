...
import com.github.shannonbay.pursue.ui.adapters.TodayGoalAdapter
...
class TodayFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        adapter = TodayGoalAdapter(emptyList(), onGoalClick = { goal, groupId ->
            logProgressHandler?.handleCardBodyClick(GoalLogProgressHandler.fromTodayGoal(goal, groupId))
        }, onArrowClick = { goal ->
            if (isAdded) {
                try {
                    val goalDetailFragment = GoalDetailFragment.newInstance(goal.goal_id)
