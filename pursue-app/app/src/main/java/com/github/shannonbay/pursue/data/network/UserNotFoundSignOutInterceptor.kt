...
class UserNotFoundSignOutInterceptor(
    ...
    override fun intercept(chain: Interceptor.Chain): Response {
        ...
        val currentToken = SecureTokenManager.getInstance(context.applicationContext).getAccessToken()
        ...
        if (wrapper.error?.code == "NOT_FOUND") {
            AuthRepository.getInstance(context.applicationContext).signOut()
        }
