...
import com.github.shannonbay.pursue.ui.fragments.goals.GoalDetailFragment
...
import com.github.shannonbay.pursue.ui.handlers.GoalLogProgressHandler
...
class GoalsTabFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        logProgressHandler = GoalLogProgressHandler(
            ...
            tokenSupplier = { SecureTokenManager.Companion.getInstance(requireContext()).getAccessToken() },
            userDate = userDate,
        ...
        cadences.forEach { cadence ->
            ...
            if (cadenceGoals.isNotEmpty()) {
                ...
                cadenceGoals.forEach { goal ->
                    ...
                    val arrowButton = goalCardView.findViewById<android.widget.ImageButton>(R.id.arrow_button)

                    goalCard.setOnClickListener {
                        logProgressHandler?.handleCardBodyClick(GoalLogProgressHandler.fromGroupGoal(goal))
                    }

                    arrowButton.setOnClickListener {
                        try {
                            val goalDetailFragment = GoalDetailFragment.newInstance(goal.id)
     ...
     */
    private fun mapGoalResponseToGroupGoal(goalResponse: com.github.shannonbay.pursue.models.GroupGoalResponse): GroupGoal {
