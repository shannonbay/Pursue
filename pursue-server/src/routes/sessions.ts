...
// Sessions
router.post('/groups/:groupId/sessions', authenticate, createSession);
router.get('/groups/:groupId/sessions/active', authenticate, getActiveSessions);
router.post('/groups/:groupId/sessions/:id/join', authenticate, joinSession);
...
// Slots
router.post('/groups/:groupId/slots', authenticate, createSlot);
router.get('/groups/:groupId/slots', authenticate, listSlots);
router.delete('/groups/:groupId/slots/:id', authenticate, cancelSlot);
router.post('/groups/:groupId/slots/:id/rsvp', authenticate, rsvpSlot);
